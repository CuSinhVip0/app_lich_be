...
class LunarDate {
    static isLeapYear(solarYear) {
        const remainder = solarYear % 19;
        return remainder === 0 || [3, 6, 9, 11, 14, 17].includes(remainder);
    }
    ...
    static convertLunar2Solar(lunarDay, lunarMonth, lunarYear, lunarLeap, timeZone) {
